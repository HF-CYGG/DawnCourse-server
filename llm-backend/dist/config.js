...
export const config = {
    ...
    nginxAccessLogFile: process.env.NGINX_ACCESS_LOG_FILE || "/shared/parsers/nginx_access.log",
    nginxErrorLogFile: process.env.NGINX_ERROR_LOG_FILE || "/shared/parsers/nginx_error.log",
    runtimeLogReadBytes: Math.max(64 * 1024, Number(process.env.RUNTIME_LOG_READ_BYTES || 8 * 1024 * 1024)),
    adminLogBufferLimit: Math.max(50, Number(process.env.ADMIN_LOG_BUFFER_LIMIT || 300)),
