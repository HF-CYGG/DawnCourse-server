...
mkdir -p /shared/parsers /var/log/nginx /data /run/redis
touch /shared/parsers/llm-backend.log /var/log/nginx/nginx_access.log /var/log/nginx/nginx_error.log
...
tail -n +1 -F /shared/parsers/llm-backend.log /var/log/nginx/nginx_access.log /var/log/nginx/nginx_error.log &
TAIL_PID=$!
